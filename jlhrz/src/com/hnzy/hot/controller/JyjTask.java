...
public class JyjTask{
	...
	public void  updatebjxx() throws NotConnectedException, DuplicateGroupException, AddFailedException, UnsupportedEncodingException, JIException, IllegalArgumentException, UnknownHostException, AlreadyConnectedException{
	 ...
	 @Scheduled(cron="0/30 * *  * * ? ")   //每5分钟一次   
	    public void updateSsb1(){      
			 ConnectionInformation ci=OPCConfiguration.getCLSIDConnectionInfomation();
		       final Server server = new Server ( ci, Executors.newSingleThreadScheduledExecutor () );
	...
	ConnectionInformation ci = OPCConfiguration.getCLSIDConnectionInfomation();
			...
			String[] d = XUtil.xsj("吉利.教育局站.写数据.");
	 ...
	 public void sbxs()
			...
			String d[]= new String[]{"吉利.教育局站.读状态.补水泵1远程就地","吉利.教育局站.读状态.补水泵2远程就地","吉利.教育局站.读状态.冷凝泵1远程就地",
					"吉利.教育局站.读状态.调节阀远程就地","吉利.教育局站.读状态.泄压阀远程就地","吉利.教育局站.读状态.泄压阀状态","吉利.教育局站.读状态.循环泵1远程就地"
					,"吉利.教育局站.读状态.循环泵2远程就地","吉利.教育局站.读状态.自来水阀远程就地","吉利.教育局站.读状态.自来水阀状态","吉利.教育局站.写状态.补水泵1强制",
					"吉利.教育局站.写状态.补水泵2强制","吉利.教育局站.写状态.补水泵控制方式","吉利.教育局站.写状态.二次供水温度设定方式","吉利.教育局站.写状态.冷凝泵1强制",
					"吉利.教育局站.写状态.冷凝泵2强制","吉利.教育局站.写状态.冷凝阀强制","吉利.教育局站.写状态.调节阀定时开关使能","吉利.教育局站.写状态.调节阀强制",
					"吉利.教育局站.写状态.泄压阀强制","吉利.教育局站.写状态.循环泵1强制","吉利.教育局站.写状态.循环泵2强制","吉利.教育局站.写状态.自来水阀强制"};
			...
			for (Entry<String, Item> temp : map.entrySet()) {
				...
				try {
					...
					String string = id.replace("吉利.教育局站.", "").replace("吉利.一委站.", "").replace("吉利.教育局站.", "").replace("写数据.", "").replace("读数据.", "").replace("写状态.", "")
							.replace("读状态.", "");
