...
$(document).ready(function() {
	...
	$('#tjTime').val(myDate.toLocaleString()); 
		...
		var xinwordList = [
			["调度室","刘伟","2019-05-04 18:23","更换传感器","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["第二大队","王五","2019-05-04 13:23","管道漏水","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["第二大队","刘伟","2019-05-04 18:23","更换计算机","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["调度室","刘伟","2019-05-04 18:23","补水管道破裂","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["调度室","刘伟","2019-05-04 18:23","更换传感器","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["第二大队","刘伟","2019-05-04 18:23","循环泵变频器损坏","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["调度室","刘伟","2019-05-04 18:23","更换传感器","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["调度室","刘伟","2019-05-04 18:23","更换传感器","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["调度室","刘伟","2019-05-04 18:23","更换传感器","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
			["第二大队","王五","2019-05-04 13:23","管道漏水","张明","2019-05-05 18:23","审批结果","处理中","处理中","完成"],
		...
		for(var i = 0;i < xinwordList.length;i ++){
			...
			for(var y = 0;y < xinwordList[i].length;y ++){
				//省略字数
//				xinwordList[i][y] = xinwordList[i][y]+"";
//				if(xinwordList[i][y].length > 15){
//					var new_xinwordList = xinwordList[i][y].slice(0,14);
//					xinwordTr += "<td>" + new_xinwordList + "···</td>";
//				}else{
...
//				}
			...
			//<input class='xinjgd_show' onclick='shower("+id+")' type='button' value='查看意见' />
			xinwordTr += "<td><input class='xinjgd_change' type='button' value='审核' /><input class='xinjgd_del' type='button' value='删除' /></td></tr>";
