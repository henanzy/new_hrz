...
public class wz2Task{
	...
	ConnectionInformation ci = OPCConfiguration.getCLSIDConnectionInfomation();
	 ...
	 public void sbxs()
			...
			String d[]= new String[]{"吉利.二委站.读状态.补水泵1远程就地","吉利.二委站.读状态.补水泵2远程就地","吉利.二委站.读状态.冷凝泵1远程就地",
					"吉利.二委站.读状态.调节阀远程就地","吉利.二委站.读状态.泄压阀远程就地","吉利.二委站.读状态.泄压阀状态","吉利.二委站.读状态.循环泵1远程就地"
					,"吉利.二委站.读状态.循环泵2远程就地","吉利.二委站.读状态.自来水阀远程就地","吉利.二委站.读状态.自来水阀状态","吉利.二委站.写状态.补水泵1强制",
					"吉利.二委站.写状态.补水泵2强制","吉利.二委站.写状态.补水泵控制方式","吉利.二委站.写状态.二次供水温度设定方式","吉利.二委站.写状态.冷凝泵1强制",
					"吉利.二委站.写状态.冷凝泵2强制","吉利.二委站.写状态.冷凝阀强制","吉利.二委站.写状态.调节阀定时开关使能","吉利.二委站.写状态.调节阀强制",
					"吉利.二委站.写状态.泄压阀强制","吉利.二委站.写状态.循环泵1强制","吉利.二委站.写状态.循环泵2强制","吉利.二委站.写状态.自来水阀强制"};
